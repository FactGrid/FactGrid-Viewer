...
const routes: Routes = [
  {
    path: '',
    loadComponent: () => import('./display/display.component').then((mod) => mod.DisplayComponent),
  },
  /*  { path: 'item/:id',
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./search/advanced-search/advanced-search.component').then(
        (mod) => mod.AdvancedSearchComponent
      ),
  },
];
