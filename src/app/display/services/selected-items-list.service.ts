...
export class SelectedItemListService {
  ...
  setPropertiesAndValues(u) {
    ...
    let qualifierItems = this.setItems(qualifiers).filter(function (element) {
  ...
  */
  ...
  createList(arr) {
    //create a string whith the elements of an array
    arr = [...new Set(arr)];
    let list = '';
