...
describe('DisplayComponent', () => {
  ...
  it('desktop: should render the FactGrid id above the title in the item header', () => {
    ...
    expect(idxId).withContext('id must appear before title in DOM for desktop view as well').toBeLessThan(idxTitle);
  });
});
