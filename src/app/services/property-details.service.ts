          ...
          for (let k = 0; k < qualifierPropertyArray.length; k++) {
            ...
            if (qualifiersArray[k][0].property === properties[l].id) {
              ...
              if (properties[l].description !== undefined)
                re.claims[itemProperties[i]][j].qualifiers[prop].description =
              ...
              if (properties[l].externalLink !== undefined)
                re.claims[itemProperties[i]][j].qualifiers[prop].externalLink =
                  properties[l].externalLink;
            }
          }
        }
      }
          ...
          for (let l = 0; l < props.length; l++) {
            for (let m = 0; m < properties.length; m++) {
              if (props[l] === properties[m].id) {
                if (
                  re.claims[itemProperties[i]][j].references[k].snaks[props[l]][0] !== undefined
                ) {
                  re.claims[itemProperties[i]][j].references[k].snaks[props[l]][0].label =
                    properties[m].label;
                  if (properties[m].description !== undefined)
                    re.claims[itemProperties[i]][j].references[k].snaks[props[l]][0].description =
                      properties[m].description;
                  if (properties[m].aliases !== undefined)
                    re.claims[itemProperties[i]][j].references[k].snaks[props[l]][0].aliases =
                      properties[m].aliases;
                  if (properties[m].externalLink !== undefined)
                    re.claims[itemProperties[i]][j].references[k].snaks[props[l]][0].externalLink =
                      properties[m].externalLink;
                }
              }
            }
          }
      ...
      for (let j = 0; j < re.claims[itemProperties[i]].length; j++) {
        ...
        for (let k = 0; k < re.claims[itemProperties[i]][j].references.length; k++) {
          ...
          for (let r = 0; r < props.length; r++) {
            ...
            if (reference.aliases !== undefined) references2[k][r].aliases = reference.aliases;
